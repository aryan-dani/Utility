      ...
      <div className="w-full max-w-sm relative z-10">
        ...
        >
          ...
          <PageHeader
            ...
            description="Enter an email and password (at least 6 characters), then tap Create account."
          />
          ...
          {(googleLoading || githubLoading) && (
            <p className="mb-4 text-xs text-muted text-center" role="status">
              Continuing in this window…
            </p>
          )}

          {preferRedirect && (
            <p className="mb-4 text-xs text-muted text-center leading-relaxed">
              Email and password is the most reliable option in the Windows app.
              Google or GitHub continue in this window; if either fails, use
              email instead.
            </p>
          )}
          ...
          <div className="grid grid-cols-2 gap-3">
            <button
              ...
              className="bg-background border border-border text-foreground py-2.5 rounded-xl text-sm font-semibold hover:bg-surface disabled:opacity-50 transition-all flex items-center justify-center gap-2 active:scale-[0.97] duration-[var(--dur-fast)] ease-[var(--ease-out-premium)] disabled:active:scale-100"
            >
              {googleLoading ? (
