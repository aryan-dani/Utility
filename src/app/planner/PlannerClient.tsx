        ...
        <PageHeader
          ...
          actions={
            ...
            {user ? (
              ...
              <AppLink
                href="/login"
                className="inline-flex items-center gap-1.5 h-8 text-xs text-muted hover:text-foreground border border-border rounded-lg px-2.5 hover:bg-surface transition-colors"
              >
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 h-8 text-xs font-semibold text-background bg-foreground border border-foreground rounded-lg px-2.5 hover:opacity-90 transition-opacity"
            >
            ...
            <div className="hidden sm:flex flex-wrap items-center gap-2">
              <button
                ...
                className="inline-flex items-center gap-1.5 h-8 text-xs font-medium text-muted hover:text-foreground border border-border rounded-lg px-2.5 hover:bg-surface transition-colors"
              >
                <Share2 className="w-3.5 h-3.5" />
                Share
              </button>
              <button onClick={exportData} className="inline-flex items-center gap-1.5 h-8 text-xs font-medium text-muted hover:text-foreground border border-border rounded-lg px-2.5 hover:bg-surface transition-colors">
                <Download className="w-3.5 h-3.5" />
                Export
              </button>
              <button onClick={exportIcs} className="inline-flex items-center gap-1.5 h-8 text-xs font-medium text-muted hover:text-foreground border border-border rounded-lg px-2.5 hover:bg-surface transition-colors">
                <CalendarDays className="w-3.5 h-3.5" />
                ICS
              </button>
              <button onClick={() => fileInputRef.current?.click()} className="inline-flex items-center gap-1.5 h-8 text-xs font-medium text-muted hover:text-foreground border border-border rounded-lg px-2.5 hover:bg-surface transition-colors">
                <Upload className="w-3.5 h-3.5" />
                Import
              </button>
              <button
                onClick={undoLastChange}
                className="inline-flex items-center justify-center h-8 w-8 text-muted hover:text-foreground border border-border rounded-lg hover:bg-surface transition-colors"
                title="Undo"
                aria-label="Undo"
              >
              ...
              <Button
                ...
                size="sm"
                onClick={clearAll}
                className="h-8 w-8 min-h-8 px-0 hover:text-destructive hover:border-destructive/30"
        ...
        <div className="flex flex-col gap-2 sm:gap-3 min-w-0">
          <div className="flex flex-col sm:flex-row sm:items-center gap-2.5 min-w-0">
            ...
            <div className="flex items-center gap-1.5 min-w-0 sm:flex-1 sm:justify-center">
              <button
                onClick={goPrevMonth}
                className="inline-flex items-center justify-center h-8 w-8 shrink-0 rounded-lg bg-surface border border-border text-muted hover:text-foreground hover:bg-surface-hover transition-colors"
              ...
              <button
                onClick={goToday}
                className="shrink-0 h-8 px-2.5 rounded-lg text-[11px] font-semibold text-muted hover:text-foreground bg-surface border border-border hover:bg-surface-hover transition-colors"
              >
                Today
              </button>
            </div>
