...
export default function AdminPage() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6 min-h-[80vh]">
      ...
      {message && (
        <div
          className={`mb-6 p-4 rounded ${message.includes("❌") ? "bg-red-50 text-red-600 border border-red-100" : "bg-emerald-50 text-emerald-600 border border-emerald-100"}`}
        >
          {message}
        </div>
      )}
                    ...
                    <div className="flex items-center gap-2">
                      {isEditing ? (
                        ...
                        <>
                          ...
                          <button
                            onClick={() =>
                              handleDelete(resource.id, resource.file_url)
                            }
