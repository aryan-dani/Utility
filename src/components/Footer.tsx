          ...
          <div className="flex flex-col md:flex-row justify-between items-start gap-10 md:gap-12 mb-10 md:mb-12">
            <div className="max-w-sm">
              <AppLink
                ...
                className="font-display text-xl tracking-tight text-foreground flex items-center gap-2 mb-3"
              >
                Utility
              </AppLink>
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 gap-8 sm:gap-12 lg:gap-16">
              <div className="space-y-3.5">
                <h4 className="text-[10px] font-bold uppercase tracking-widest text-foreground/50">
                  Workspace
                </h4>
